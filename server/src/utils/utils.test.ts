import { sortData, transformData, processData, NormalizedContentCardType, ContentCardType } from './utils';
...
describe('sortData', () => {
    it('should sort data by priority', () => {
        const data = [
            ...
            { id: 2, priority: 1 },
            { id: 3, priority: 3 }
        ] as unknown as NormalizedContentCardType[];
        const sortedData = [
            { id: 3, priority: 3 },
            { id: 1, priority: 2 },
            { id: 2, priority: 1 },
...
describe('transformData', () => {
    it('should transform raw data into a normalized structure', () => {
        ...
        } as unknown as { contentCards: ContentCardType[] }
        const expectedData = [
            {
                id: '1',
                title: 'Title',
